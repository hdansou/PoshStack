...
function Add-ComputeServerVolume{
    ...
    try {
        ...
        # DEBUGGING       
        Write-Debug -Message "Add-ComputeServerVolume"
...
<#
 ...
 .DESCRIPTION
 The Add-ComputeServerVolume cmdlet will allow you to connect an existing storage volume to a virtual machine. You can optionally name the volume.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Add-ComputeServerVolume -Account demo -ServerId "3131589f-429f-40dc-87ee-492275990909" -VolumeId "bar"
 This example will attach the volume "bar" to the server "3131589f-429f-40dc-87ee-492275990909".

 .EXAMPLE
 PS C:\Users\Administrator> Add-ComputeServerVolume -Account demo -ServerId "3131589f-429f-40dc-87ee-492275990909" -VolumeId "bar" -StorageDevice "DDrive"
...
function Set-ComputeServerAdministratorPassword{
    Param(
        [Parameter (Mandatory=$True)] [string] $Account = $(throw "Please specify required Cloud Account with -Account parameter"),
        [Parameter (Mandatory=$True)] [string] $ServerId = $(throw "Server Id is required"),
    ...
    try {
        ...
        # DEBUGGING       
        Write-Debug -Message "Set-ComputeServerAdministratorPassword"
        Write-Debug -Message "Account.......: $Account" 
        Write-Debug -Message "RegionOverride: $RegionOverride" 
        Write-Debug -Message "ServerId......: $ServerId" 
...
<#
 ...
 .DESCRIPTION
 The Set-ComputeServerAdministratorPassword cmdlet changes the administrator password for a specified server. The administrator password is the root password for the server.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Set-ComputeServerAdministratorPassword -Account demo -ServerId "3131589f-429f-40dc-87ee-492275990909" -Password "P4$$w0rd_is_weak"
...
#ConfirmServerResize
#CreateImage
function New-ComputeServerImage{
    Param(
        [Parameter (Mandatory=$True)] [string]    $Account    = $(throw "Please specify required Cloud Account with -Account parameter"),
        [Parameter (Mandatory=$True)] [string]    $ServerId   = $(throw "Server Id is required"),
...
<#
 .SYNOPSIS
 The New-ComputeServerImage creates a new image for a specified server..
 ...
 .EXAMPLE
 PS C:\Users\Administrator> New-ComputeServerImage -Account Dev -ServerId "foo" -ImageName "MyNewImage"
...
function Get-ComputeServerVolumeDetails{
    Param(
        [Parameter (Mandatory=$True)] [string] $Account = $(throw "Please specify required Cloud Account with -Account parameter"),
...
<#
 .SYNOPSIS
 The Get-ComputeServerVolumeDetails cmdlet gets detailed information about the specified server-attached volume.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServerVolumeDetails -Account demo -ServerId "foo" -VolumeId "foo-volume-id"
...
#ListAddresses
function Get-ComputeServerAddresses{
    Param(
        [Parameter (Mandatory=$True)] [string] $Account = $(throw "Please specify required Cloud Account with -account parameter"),
        [Parameter (Mandatory=$False)][string] $RegionOverride,
    ...
    # DEBUGGING   
    Write-Debug -Message "Get-ComputeServerAddresses"          
    Write-Debug -Message "ServerId.....: $ServerId"
    Write-Debug -Message "Region.......: $Region"
...
<#
 .SYNOPSIS
 The Get-ComputeServerAddresses cmdlet gets addresses and networks for server.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServerAddresses -Account demo -ServerId "foo" 
...
function Update-ComputeServer{
    ...
    # DEBUGGING   
    Write-Debug -Message "Update-ComputeServer"          
    Write-Debug -Message "ServerId.....: $ServerId"
...
<#
 .SYNOPSIS
 The Update-ComputeServer cmdlet updates one or more editable attributes for a specified server.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Update-ComputeServer -Account demo -ServerId "foo" -ServerName "TheNewName"
...
#ListFlavors
#ListFlavorsWithDetails
function Get-ComputeServerFlavors {
    Param(
        [Parameter (Mandatory=$True)] [string] $Account = $(throw "Please specify required Cloud Account with -account parameter"),
        [Parameter (Mandatory=$False)][string] $RegionOverride,
...
<#
 ...
 .DESCRIPTION
 The Get-ComputeServerFlavors cmdlet will retrieve a list of Cloud Server Flavors.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServerFlavors -Account prod
 This example shows how to get a list of all available Flavors in the account prod

 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServerFlavors cloudus -RegionOverride DFW
 This example shows how to get a list of all available Flavors for cloudus account in DFW region

 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServerFlavors cloudus -MinDiskInGB 100
...
#ListImages
#ListImagesWithDetails
function Get-ComputeServerImages {
...
<#
 ...
 .DESCRIPTION
 The Get-ComputeServerImages cmdlet will retreive a list of all Rackspace Cloud Server image snapshots for a given account, including Rackspace's base OS images.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServerImages -Account prod
 This example shows how to get a list of all available Images in the account prod

 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServerImages cloudus -RegionOverride DFW
 This example shows how to get a list of all available Images for cloudus account in DFW region

 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServerImages cloudus -ImageType ([net.openstack.Core.Domain.ImageType]::Base) 
...
<#
 ...
 .DESCRIPTION
 The Get-ComputeServers cmdlet will display a list of all cloud server instances on a given account in a given cloud region.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServers -account cloud
 This example shows how to get a list of all servers currently deployed in specified account.

 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServers cloudus -RegionOverride ORD
...
#GetDetails
function Get-ComputeServerDetails {
...
<#
 .SYNOPSIS
 The Get-ComputeServerDetails cmdlet will pull down a list of detailed information for a specific Rackspace Cloud Server.
 ...
 .PARAMETER ServerId
 Use this parameter to specify Cloud Server UUID, details of which you want query. Run the "Get-ComputeServers" cmdlet for a complete listing of servers.

 .PARAMETER RegionOverride
 This parameter will temporarily override the default region set in PoshStack configuration file. 

 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServerDetails -ServerId abc123ef-9876-abcd-1234-123456abcdef -Account prod
 This example shows how to get explicit data about one cloud server from the account Prod

 .EXAMPLE
 PS C:\Users\Administrator> Get-ComputeServerDetails -ServerId abc123ef-9876-abcd-1234-123456abcdef -Account Dev 
 
 PS C:\Users\mitch.robins> Get-ComputeServerDetails -ServerId abc123ef-9876-abcd-1234-123456abcdef -Account Prod
...
#ListServerVolumes
function Get-ComputeServerVolumes {
...
<#
 .SYNOPSIS
 The Get-ComputeServerVolumes cmdlet will pull down a list of detailed information for a specific Cloud Server.
...
<#
 .SYNOPSIS
 The New-ComputeServer cmdlet will create a Virtual Machine.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> New-ComputeServer -Account Dev -ServerName "MyNewServer" -ImageId "foo" -FlavorId "bar"
...
<#
 .SYNOPSIS
 The Remove-ComputeServer cmdlet will delete a Virtual Machine.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Remove-ComputeServer -ServerId abc123ef-9876-abcd-1234-123456abcdef -Account prod
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Remove-ComputeServer -ServerId abc123ef-9876-abcd-1234-123456abcdef -Account prod -RegionOverride "SYD"
...
#RebootServer
function Restart-ComputeServer{
    Param(
        [Parameter(Mandatory=$true)] [string]$Account = $(throw "Please specify required Cloud Account with -Account parameter"),
        [Parameter(Mandatory=$true)] [string]$ServerId = $(throw "Please specify server Id with -ServerId parameter"),
...
<#
 .SYNOPSIS
 The Restart-ComputeServer cmdlet will reboot a Virtual Machine.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Restart-ComputeServer -ServerId abc123ef-9876-abcd-1234-123456abcdef -Account prod
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Restart-ComputeServer -ServerId abc123ef-9876-abcd-1234-123456abcdef -Account prod -RegionOverride "SYD"
...
#RebuildServer
function Initialize-ComputeServer{
    Param(
        [Parameter(Mandatory=$true)] [string] $Account = $(throw "Please specify required Cloud Account with -Account parameter"),
        [Parameter(Mandatory=$true)] [string] $ServerId = $(throw "Please specify server Id with -ServerId parameter"),
        [Parameter(Mandatory=$true)] [string] $ServerName = $(throw "Please specify server name with -ServerName parameter"),
    ...
    # DEBUGGING   
    Write-Debug -Message "Initialize-ComputeServer"          
    Write-Debug -Message "ServerId.....: $ServerId"
    Write-Debug -Message "ServerName...: $ServerName"
    Write-Debug -Message "ImageId......: $ImageId"
    Write-Debug -Message "FlavorId.....: $FlavorId"
...
<#
 .SYNOPSIS
 The Initialize-ComputeServer cmdlet will rebuild a Virtual Machine.

 .DESCRIPTION
 The Initialize-ComputeServer cmdlet removes all data on the server and replaces it with the specified image. The serverRef and all IP addresses remain the same.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Initialize-ComputeServer -ServerId abc123ef-9876-abcd-1234-123456abcdef -ImageId "foo" -FlavorId "bar" -Account prod
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Initialize-ComputeServer -ServerId abc123ef-9876-abcd-1234-123456abcdef -ImageId "foo" -FlavorId "bar" -Account prod -AdminPassword "ju289732$$_X#"
...
function Resize-ComputeServer{
    ...
    # DEBUGGING   
    Write-Debug -Message "Resize-ComputeServer"          
    Write-Debug -Message "ServerId.....: $ServerId"
    Write-Debug -Message "ServerName...: $ServerName"
    Write-Debug -Message "FlavorId.....: $FlavorId"
    Write-Debug -Message "DiskConfig...: $DiskConfig"
...
<#
 .SYNOPSIS
 The Resize-ComputeServer cmdlet will resize a Virtual Machine.

 .DESCRIPTION
 The Resize-ComputeServer cmdlet converts an existing Standard server to a different flavor, which scales the server up or down.
 ...
 .EXAMPLE
 PS C:\Users\Administrator> Resize-ComputeServer -ServerId abc123ef-9876-abcd-1234-123456abcdef -FlavorId "performance1-2" -Account prod
